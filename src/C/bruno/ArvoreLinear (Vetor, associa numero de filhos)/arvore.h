...
void geradorArvore(Arvore* arv, int maxTam, int* conjuntoOpTerm, int NUM_OPBIN, int NUM_OPUN, int N);///preenche uma árvore com um numero máximo de nós 'maxTam'
void criaCheia(Arvore* arv, int maxDepth, int* conjuntoOpTerm, int NUM_OPBIN, int NUM_OPUN, int N);///dada uma profundidade maxima, preenche a arvore ate essa profundidade
...
void mutacao(Arvore* arvore, int* conjuntoOpTerm, int NUM_OPBIN, int NUM_OPUN, int N); ///Sorteia uma sub-arvore aleatória e troca por outra
