...
void copiaSubArv(Arvlin* arv,Arvlin* arv2,int onde1,int onde2){    
    int tamSubArv2=calcTamSubArv(arv2->filhos ,&onde2);   
    for(; onde2 < tamSubArv2 ;onde1++,onde2++){
            arv->elementos[onde1]=arv2->elementos[onde2];//colocar ruido aqui;
            arv->filhos[onde1]=arv2->filhos[onde2];
        }
}
